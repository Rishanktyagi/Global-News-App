package com.example.android.wallpaper.adapters;
...
public class WallpaperAdapter extends RecyclerView.Adapter<WallpaperViewHolder> {
    ...
    public void onBindViewHolder(@NonNull WallpaperViewHolder holders, int position) {
        ...
        Glide.with(context).load(model.getMediumUrl()).into(holders.imageView);
        holders.imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //later we will add functionality
